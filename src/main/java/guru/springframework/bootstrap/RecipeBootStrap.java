...
public class RecipeBootStrap implements ApplicationListener<ContextRefreshedEvent>{
    ...
    private List<Recipe> getRecipes(){
        ...
        eachUomOptional.orElseThrow(()->new RuntimeException("Expected UOM Not Found"));
        Optional<UnitOfMeasure> tableSpoonUomOptional = unitOfMeasureRepository.findByDescription("Tablespoon");
        tableSpoonUomOptional.orElseThrow(()->new RuntimeException("Expected UOM Not Found"));
        Optional<UnitOfMeasure> teaSpoonUomOptional = unitOfMeasureRepository.findByDescription("Teaspoon");
        teaSpoonUomOptional.orElseThrow(()->new RuntimeException("Expected UOM Not Found"));
        Optional<UnitOfMeasure> dashUomOptional = unitOfMeasureRepository.findByDescription("Dash");
        dashUomOptional.orElseThrow(()->new RuntimeException("Expected UOM Not Found"));
        Optional<UnitOfMeasure> pintUomOptional = unitOfMeasureRepository.findByDescription("Pint");
        pintUomOptional.orElseThrow(()->new RuntimeException("Expected UOM Not Found"));
        Optional<UnitOfMeasure> cupsUomOptional = unitOfMeasureRepository.findByDescription("Cup");
        cupsUomOptional.orElseThrow(()->new RuntimeException("Expected UOM Not Found"));
        ...
        americanCategoryOptional.orElseThrow(()->new RuntimeException("Expected Category Not Found"));
        Optional<Category> mexicanCategoryOptional = categoryRepository.findByDescription("Mexican");
        mexicanCategoryOptional.orElseThrow(()->new RuntimeException("Expected Category Not Found"));
        ...
        guacRecipe.setUrl("http://www.simplerecipes.com/recipes/perfect_guacomole/");
